...
// req.registerOption("username",fromString, toString)
// req.registerOption("password",fromString, toString)
req.setOption("555", [new Buffer.from("test"), new Buffer.from("mytest32")])
//req.setHeaders("test","mytest32")
